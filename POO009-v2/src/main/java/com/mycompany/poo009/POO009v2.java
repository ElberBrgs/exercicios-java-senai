...
public class POO009v2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Setor: "+funcionarioUm.getSetor().getTextoSetor());
        System.out.println("Sexo: "+funcionarioUm.getSexo().getTextoSexo());
        ...
        System.out.println("Setor: "+funcionarioDois.getSetor().getTextoSetor());
        System.out.println("Sexo: "+funcionarioDois.getSexo().getTextoSexo());
